...
import { Activity, Mail, Lock, User, ArrowRight, Eye, EyeOff, CheckCircle } from 'lucide-react';
...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setUser({ ...mockUser, email, name, onboardingComplete: true });
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold tracking-tight leading-tight">
                Start finding
                <br />
                <span className="text-primary">validated ideas</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-md leading-relaxed">
                Join founders who use Reddit insights to build products people actually want.
              </p>
            </div>
            
            <div className="space-y-4">
              {[
                'Analyze thousands of Reddit posts',
                'Discover recurring pain points',
                'Generate actionable SaaS ideas',
                'Get MVP specs & validation plans',
              ].map((feature, i) => (
